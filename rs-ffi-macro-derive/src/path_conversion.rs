...
use crate::path_arguments_to_paths;
...
impl PathConversion {
    ...
    // fn mangled_generic_arguments_paths(&self) -> Vec<Path> {
    //     self.as_path()
    //         .segments
    //         .iter()
    //         .flat_map(|PathSegment { arguments, .. }|
    //             path_arguments_to_paths(arguments)
    //                 .into_iter()
    //                 .map(Self::mangled_ffi_path)
    //                 .collect::<Vec<_>>())
    //         .collect()
    // }
    // fn mangled_generic_arguments_conversion_types(&self) -> Vec<PathConversion> {
    //     self.mangled_generic_arguments_paths()
    //         .iter()
    //         .map(Self::from)
    //         .collect()
    // }
...
impl PathConversion {
    // pub fn mangled_root_path(&self) -> Path {
    //     match self {
    //         PathConversion::Simple(path) | PathConversion::Complex(path) => path.clone(),
    //         PathConversion::Vec(path) => Path {
    //             segments: Punctuated::from_iter(vec![
    //                 PathSegment::from(format_mangled_ident!("Vec_{}_FFI", VEC_PATH_PRESENTER(&path)))
    //             ]),
    //             leading_colon: None,
    //         },
    //         PathConversion::Map(path) => Path {
    //             segments: Punctuated::from_iter(vec![
    //                 PathSegment::from(format_mangled_ident!("Map_{}_FFI", MAP_PATH_PRESENTER(&path)))
    //             ]),
    //             leading_colon: None,
    //         }
    //     }
    ...
    pub fn mangled_root_ident(&self) -> Ident {
        self.mangled_ident(match self {
            ...
            // PathConversion::Vec(..) => VEC_PATH_PRESENTER,
            // PathConversion::Map(..) => MAP_PATH_PRESENTER,
