        ...
        pub mod transport_request {
            ...
            pub struct TransportRequest_VTable {
                pub execute_transport : unsafe extern "C" fn (
                    obj : * const () ,
                    client : * mut crate :: fermented :: types :: transport :: transport_request :: TransportRequest :: Client
                ) -> * mut crate :: fermented :: generics :: Result_ok_crate_transport_transport_request_TransportRequest_Response_err_crate_transport_transport_request_TransportClient_Error , }
            #[repr(C)]
            #[derive(Clone)]
