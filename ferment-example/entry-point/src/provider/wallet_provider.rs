...
use std::sync::Arc;
use crate::provider::wallet_ex::WalletEx2;
...
pub struct WalletProvider2 {
    ...
    // commit_transaction: Arc<dyn Fn(*const c_void, Vec<[u8; 32]>, [u8; 32], bool, [u8; 32]) -> bool>,
...
impl WalletProvider2 {
    ...
    pub fn new<'a,
        ...
        AC: Fn(*const c_void, bool, [u8; 32], &WalletEx2) -> Vec<[u8; 32]> + 'static,
        // SC: Fn(*const c_void, bool, bool, bool, i32) -> Vec<[u8; 32]> + 'static,
        // IWA: Fn(*const c_void, u64) -> u32 + 'static,
        // FCA: Fn(*const c_void, bool) -> Vec<u8> + 'static,
        // CT: Fn(*const c_void, Vec<[u8; 32]>, [u8; 32], bool, [u8; 32]) -> bool + 'static,
        ...
        // GCK: Fn(*const c_void, bool) -> Vec<Vec<u8>> + 'static,
    >(
...
impl WalletProvider2 {
    ...
    */
    ...
    pub(crate) fn sign_transaction(&self, tx: &[u8; 32], anyone_can_pay: bool) -> Option<[u8; 32]> {
        ...
        (self.sign_transaction)(std::ptr::null(), tx, anyone_can_pay)
    }
