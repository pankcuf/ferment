...
impl WalletProvider {
    ...
    pub fn new<
        ...
        SC: Fn(*const c_void, bool, bool, bool, i32) -> Vec<CompactTallyItem> + 'static,
...
impl WalletProvider {
    ...
    */
    ...
    pub(crate) fn select_coins(&self, skip_denominated: bool, anonymizable: bool, skip_unconfirmed: bool, max_outpoints_per_address: i32) -> Vec<CompactTallyItem> {
