...
pub mod types {
    ...
    pub mod nested {
        ...
        impl ferment_interfaces::FFIConversion<crate::nested::IdentifierBytes32> for IdentifierBytes32 {
            unsafe fn ffi_from_const(ffi: *const IdentifierBytes32) -> crate::nested::IdentifierBytes32 {
                let ffi_ref = &*ffi;
                crate::nested::IdentifierBytes32(*ffi_ref.0)
            }
            unsafe fn ffi_to_const(obj: crate::nested::IdentifierBytes32) -> *const IdentifierBytes32 {
        ...
        pub mod service {
            ...
            pub unsafe extern "C" fn ffi_get_chain_type_string_async(
                ...
                let obj = rt.block_on(async {
                    let obj = crate::asyn::service::get_chain_type_string_async(
                        ferment_interfaces::FFIConversion::ffi_from(chain_type),
                    )
                    .await;
                    obj
