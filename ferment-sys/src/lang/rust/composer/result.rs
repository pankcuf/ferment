...
impl SourceComposable for ResultComposer<RustSpecification> {
    ...
    fn compose(&self, source: &Self::Source) -> Self::Output {
        ...
        let interfaces = Depunctuated::from_iter([
            ...
            InterfacePresentation::drop(&attrs, ffi_type.clone(), drop_body)
        ]);
        let bindings = {
            #[cfg(feature = "accessors")]
            {
                ...
                let error_context = (signature_context, ffi_type, var_error);
        ...
        Some(GenericComposerInfo::<RustSpecification>::default_with_bindings(aspect, &attrs, field_composers, interfaces, bindings))
    }
}
