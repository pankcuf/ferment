...
use crate::conversion::{DictFermentableModelKind, DictTypeModelKind, ObjectKind, SmartPointerModelKind, TypeModelKind};
use crate::ext::{FFISpecialTypeResolve, GenericNestedArg, MaybeLambdaArgs, Primitive, Resolve, SpecialType, ToType};
            ...
            _ => {
                match composition {
                    ...
                    TypeModelKind::Optional(..) => {
                        ...
                        let (expr_kind, ffi_type, target_type) = match full_nested_ty.maybe_special_type(source) {
                            ...
                            _ => {
                                (full_nested_ty.is_primitive().then_some(ConversionExpressionKind::PrimitiveOpt).unwrap_or(ConversionExpressionKind::ComplexOpt), ffi_type, full_nested_ty.to_type())
                            }
                        };
