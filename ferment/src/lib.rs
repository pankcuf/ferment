...
// }
// impl ferment::FFIConversionFrom<std::sync::Arc<dash_sdk::internal_cache::InternalSdkCache>> for std_sync_Arc_dash_sdk_internal_cache_InternalSdkCache
// {
...
//     }
// }
// impl ferment::FFIConversionTo<std::sync::Arc<dash_sdk::internal_cache::InternalSdkCache>> for std_sync_Arc_dash_sdk_internal_cache_InternalSdkCache {
...
//         ferment::boxed(Self { obj: std::sync::Arc::into_raw(obj) as *mut _ })
//     }
// }
// impl ferment::FFIConversionDestroy<std::sync::Arc<dash_sdk::internal_cache::InternalSdkCache>> for std_sync_Arc_dash_sdk_internal_cache_InternalSdkCache {
//     unsafe fn destroy(ffi: *mut std_sync_Arc_dash_sdk_internal_cache_InternalSdkCache) {
//         let _ = ferment::unbox_any(ffi);
//     }
// }
