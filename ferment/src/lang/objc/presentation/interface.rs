    ...
    fn to_tokens(&self, tokens: &mut TokenStream2) {
        match self {
            InterfacePresentation::Default { name, c_type, properties } => {
                ...
                body.push(quote!(+ (instancetype)initWith:(#c_type)self_;));
