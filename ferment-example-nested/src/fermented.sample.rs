...
pub mod types {
    pub mod ferment_example {
        pub mod nested {
            ...
            #[repr(C)]
            #[derive(Clone)]
            pub struct ferment_example_nested_DataContractNotPresentError {
                pub data_contract_id : * mut crate :: fermented :: types :: ferment_example ::nested::ferment_example_nested_Identifier
            }
            impl
            ...
            #[doc = r" # Safety"]
            #[no_mangle]
            pub unsafe extern "C" fn ferment_example_nested_DataContractNotPresentError_get_data_contract_id (obj : * const ferment_example_nested_DataContractNotPresentError) -> * mut crate :: fermented :: types :: ferment_example :: nested :: ferment_example_nested_Identifier{
                (*obj).data_contract_id
            }
            #[doc = r" # Safety"]
            #[no_mangle]
            ...
            #[repr(C)]
            #[derive(Clone)]
            pub struct ferment_example_nested_PlatformVersion {
                pub protocol_version : u32 ,
                pub identity : * mut crate :: fermented :: types :: ferment_example :: nested ::ferment_example_nested_FeatureVersionBounds ,
                pub proofs : * mut crate :: fermented :: types :: ferment_example :: nested ::ferment_example_nested_FeatureVersionBounds
            }
            ...
            #[doc = r" # Safety"]
            #[no_mangle]
            pub unsafe extern "C" fn ferment_example_nested_PlatformVersion_get_identity (obj : * const ferment_example_nested_PlatformVersion) -> * mut crate :: fermented :: types :: ferment_example :: nested :: ferment_example_nested_FeatureVersionBounds{
                (*obj).identity
            }
            #[doc = r" # Safety"]
            #[no_mangle]
            pub unsafe extern "C" fn ferment_example_nested_PlatformVersion_get_proofs (obj : * const ferment_example_nested_PlatformVersion) -> * mut crate :: fermented :: types :: ferment_example :: nested :: ferment_example_nested_FeatureVersionBounds{
                (*obj).proofs
            }
            #[doc = r" # Safety"]
            #[no_mangle]
            ...
            pub enum ferment_example_nested_ProtocolError {
                ...
                DataContractNotPresentError (* mut crate :: fermented :: types :: ferment_example :: nested :: ferment_example_nested_DataContractNotPresentError) ,
            ...
            impl Drop for ferment_example_nested_ProtocolError {
                fn drop(&mut self) {
                    unsafe {
                        match self {
                            ferment_example_nested_ProtocolError :: IdentifierError (o_0) => { < std :: os :: raw :: c_char as ferment_interfaces :: FFIConversion < String >> :: destroy (* o_0) } ,
                            ferment_example_nested_ProtocolError :: StringDecodeError (o_0) => { < std :: os :: raw :: c_char as ferment_interfaces :: FFIConversion < String >> :: destroy (* o_0) } , ferment_example_nested_ProtocolError :: StringDecodeError2 (o_0 , o_1) => { < std :: os :: raw :: c_char as ferment_interfaces :: FFIConversion < String >> :: destroy (* o_0) ; } ,
                            ferment_example_nested_ProtocolError :: EmptyPublicKeyDataError => { } , ferment_example_nested_ProtocolError :: MaxEncodedBytesReachedError { max_size_kbytes , size_hit } => { ; } ,
                            ferment_example_nested_ProtocolError :: EncodingError (o_0) => { < std :: os :: raw :: c_char as ferment_interfaces :: FFIConversion < String >> :: destroy (* o_0) } ,
                            ferment_example_nested_ProtocolError :: EncodingError2 (o_0) => { < std :: os :: raw :: c_char as ferment_interfaces :: FFIConversion < & str >> :: destroy (* o_0) } ,
                            ferment_example_nested_ProtocolError :: DataContractNotPresentError (o_0) => { ferment_interfaces :: unbox_any (* o_0) ; } ,
                            ferment_example_nested_ProtocolError :: UnknownVersionMismatch { method , known_versions , received } => {
            ...
            #[repr(C)]
            #[derive(Clone)]
            pub struct ferment_example_nested_FeatureVersionBounds {
                pub min_version : * mut crate :: fermented :: types :: ferment_example :: nested :: ferment_example_nested_FeatureVersion ,
            ...
            #[doc = r" # Safety"]
            #[no_mangle]
            pub unsafe extern "C" fn ferment_example_nested_FeatureVersionBounds_get_min_version (obj : * const ferment_example_nested_FeatureVersionBounds) -> * mut crate :: fermented :: types :: ferment_example :: nested :: ferment_example_nested_FeatureVersion{
                (*obj).min_version
            }
            #[doc = r" # Safety"]
            #[no_mangle]
            pub unsafe extern "C" fn ferment_example_nested_FeatureVersionBounds_get_max_version (obj : * const ferment_example_nested_FeatureVersionBounds) -> * mut crate :: fermented :: types :: ferment_example :: nested :: ferment_example_nested_FeatureVersion{
                (*obj).max_version
            }
            #[doc = r" # Safety"]
            #[no_mangle]
            pub unsafe extern "C" fn ferment_example_nested_FeatureVersionBounds_get_default_current_version (obj : * const ferment_example_nested_FeatureVersionBounds) -> * mut crate :: fermented :: types :: ferment_example :: nested :: ferment_example_nested_FeatureVersion{
                (*obj).default_current_version
            }
            #[doc = r" # Safety"]
            #[no_mangle]
            ...
            #[doc = r" # Safety"]
            #[no_mangle]
            pub unsafe extern "C" fn ferment_example_nested_Identifier_get_0 (obj : * const ferment_example_nested_Identifier) -> * mut crate :: fermented :: types :: ferment_example :: nested :: ferment_example_nested_IdentifierBytes32{
                (*obj).0
            }
            #[doc = r" # Safety"]
            #[no_mangle]
        ...
        pub mod identity {
            pub mod identity {
                    ...
                    > for ferment_example_identity_identity_ContractBounds
                {
                    unsafe fn ffi_from_const(
                        ...
                        match ffi_ref {
                            ferment_example_identity_identity_ContractBounds :: SingleContract { id } =>
                                ferment_example :: identity :: identity :: ContractBounds :: SingleContract { id : ferment_interfaces :: FFIConversion :: ffi_from (* id) } ,
                            ferment_example_identity_identity_ContractBounds :: SingleContractDocumentType { id , document_type_name } =>
                                ferment_example :: identity :: identity :: ContractBounds :: SingleContractDocumentType { id : ferment_interfaces :: FFIConversion :: ffi_from (* id) , document_type_name : ferment_interfaces :: FFIConversion :: ffi_from (* document_type_name) }
                        }
                    }
                    unsafe fn ffi_to_const(
                    ...
                    {
                        ferment_interfaces :: boxed (match obj {
                            ferment_example :: identity :: identity :: ContractBounds :: SingleContract { id } =>
                                ferment_example_identity_identity_ContractBounds :: SingleContract { id : ferment_interfaces :: FFIConversion :: ffi_to (id) } ,
                            ferment_example :: identity :: identity :: ContractBounds :: SingleContractDocumentType { id , document_type_name } =>
                                ferment_example_identity_identity_ContractBounds :: SingleContractDocumentType {
                                    id : ferment_interfaces :: FFIConversion :: ffi_to (id) ,
                                    document_type_name : ferment_interfaces :: FFIConversion :: ffi_to (document_type_name)
                                }
                        })
                    }
                    ...
                    fn drop(&mut self) {
                        unsafe {
                            match self {
                                ...
                                ferment_example_identity_identity_ContractBounds :: SingleContractDocumentType { id , document_type_name } => {
                                    ferment_interfaces :: unbox_any (* id) ; ;
                                    < std :: os :: raw :: c_char as ferment_interfaces :: FFIConversion < String >> :: destroy (* document_type_name)
                                }
                            } ;
                        }
                    }
                ...
                pub unsafe extern "C" fn create_platform_v0 (
                    identity: *mut crate::fermented::types::ferment_example::nested::ferment_example_nested_FeatureVersionBounds ,
                // proofs : * mut crate :: fermented :: types :: ferment_example_nested :: nested :: crate_nested_FeatureVersionBounds
                    proofs: *mut crate::fermented::types::ferment_example::nested::ferment_example_nested_FeatureVersionBounds ,
                ) -> *mut crate::fermented::types::ferment_example::nested::ferment_example_nested_PlatformVersion{
                    // ) -> * mut crate :: fermented :: types :: ferment_example_nested :: nested :: crate_nested_PlatformVersion {
                    //     let obj = crate :: identity :: identity :: create_platform_v0 (ferment_interfaces :: FFIConversion :: ffi_from (identity) , ferment_interfaces :: FFIConversion :: ffi_from (proofs)) ;
                ...
                #[repr(C)]
                #[derive(Clone)]
                pub struct ferment_example_identity_identity_IdentityPublicKeyV0 {
                    pub id : * mut crate :: fermented :: types :: ferment_example :: identity :: identity :: ferment_example_identity_identity_KeyID ,
                    pub purpose : * mut crate :: fermented :: types :: ferment_example :: identity :: identity :: ferment_example_identity_identity_Purpose ,
                    pub security_level : * mut crate :: fermented :: types :: ferment_example :: identity :: identity :: ferment_example_identity_identity_SecurityLevel ,
                    ...
                    pub read_only : bool ,
                    pub data : * mut crate :: fermented :: types :: ferment_example :: nested :: ferment_example_nested_BinaryData ,
                    pub disabled_at : * mut crate :: fermented :: types :: ferment_example :: identity :: identity :: ferment_example_identity_identity_TimestampMillis
                }
                impl
                    ferment_interfaces::FFIConversion<
                ...
                pub unsafe extern "C" fn ferment_example_identity_identity_IdentityPublicKeyV0_ctor(
                    ...
                    read_only: bool,
                    // data : * mut crate :: fermented :: types :: ferment_example_nested :: nested :: crate_nested_BinaryData ,
                    data : * mut crate :: fermented :: types :: ferment_example::nested::ferment_example_nested_BinaryData,
                    // disabled_at : * mut crate :: fermented :: types :: ferment_example :: identity :: identity :: TimestampMillis
                ...
                #[doc = r" # Safety"]
                #[no_mangle]
                pub unsafe extern "C" fn ferment_example_identity_identity_IdentityPublicKeyV0_get_id (obj : * const ferment_example_identity_identity_IdentityPublicKeyV0) -> * mut crate :: fermented :: types :: ferment_example :: identity :: identity :: ferment_example_identity_identity_KeyID{
                    (*obj).id
                }
                #[doc = r" # Safety"]
                #[no_mangle]
                pub unsafe extern "C" fn ferment_example_identity_identity_IdentityPublicKeyV0_get_purpose (obj : * const ferment_example_identity_identity_IdentityPublicKeyV0) -> * mut crate :: fermented :: types :: ferment_example :: identity :: identity :: ferment_example_identity_identity_Purpose{
                    (*obj).purpose
                }
                #[doc = r" # Safety"]
                #[no_mangle]
                pub unsafe extern "C" fn ferment_example_identity_identity_IdentityPublicKeyV0_get_security_level (obj : * const ferment_example_identity_identity_IdentityPublicKeyV0) -> * mut crate :: fermented :: types :: ferment_example :: identity :: identity :: ferment_example_identity_identity_SecurityLevel{
                    (*obj).security_level
                }
                #[doc = r" # Safety"]
                #[no_mangle]
                pub unsafe extern "C" fn ferment_example_identity_identity_IdentityPublicKeyV0_get_contract_bounds (obj : * const ferment_example_identity_identity_IdentityPublicKeyV0) -> * mut crate :: fermented :: types :: ferment_example :: identity :: identity :: ferment_example_identity_identity_ContractBounds{
                    (*obj).contract_bounds
                }
                #[doc = r" # Safety"]
                #[no_mangle]
                pub unsafe extern "C" fn ferment_example_identity_identity_IdentityPublicKeyV0_get_key_type (obj : * const ferment_example_identity_identity_IdentityPublicKeyV0) -> * mut crate :: fermented :: types :: ferment_example :: identity :: identity :: ferment_example_identity_identity_KeyType{
                    (*obj).key_type
                }
                #[doc = r" # Safety"]
                #[no_mangle]
                ...
                #[doc = r" # Safety"]
                #[no_mangle]
                pub unsafe extern "C" fn ferment_example_identity_identity_IdentityPublicKeyV0_get_data (obj : * const ferment_example_identity_identity_IdentityPublicKeyV0) -> * mut crate :: fermented :: types :: ferment_example :: nested :: ferment_example_nested_BinaryData{
                    (*obj).data
                }
                #[doc = r" # Safety"]
                #[no_mangle]
                pub unsafe extern "C" fn ferment_example_identity_identity_IdentityPublicKeyV0_get_disabled_at (obj : * const ferment_example_identity_identity_IdentityPublicKeyV0) -> * mut crate :: fermented :: types :: ferment_example :: identity :: identity :: ferment_example_identity_identity_TimestampMillis{
                    (*obj).disabled_at
                }
                #[doc = r" # Safety"]
                #[no_mangle]
                ...
                #[doc = r" # Safety"]
                #[no_mangle]
                pub unsafe extern "C" fn create_basic_identity (
                    id : * mut [u8 ; 32] ,
                    _platform_version : * mut crate :: fermented :: types :: ferment_example :: nested :: ferment_example_nested_PlatformVersion
                ) -> * mut crate :: fermented :: generics :: Result_ok_ferment_example_identity_identity_Identity_err_crate_nested_ProtocolError{
                ...
                #[doc = r" # Safety"]
                #[no_mangle]
                pub unsafe extern "C" fn create_basic_identity_v0 (id : * mut [u8 ; 32]) -> * mut crate :: fermented :: types :: ferment_example :: identity :: identity :: ferment_example_identity_identity_Identity{
                    let obj =
                ...
                #[repr(C)]
                #[derive(Clone)]
                pub struct ferment_example_identity_identity_IdentityV0 {
                    pub id : * mut crate :: fermented :: types :: ferment_example:: nested :: ferment_example_nested_Identifier ,
                    ...
                    pub balance : u64 ,
                    pub revision : * mut crate :: fermented :: types :: ferment_example :: identity :: identity :: ferment_example_identity_identity_Revision
                }
                impl
                    ferment_interfaces::FFIConversion<
                ...
                #[doc = r" # Safety"]
                #[no_mangle]
                pub unsafe extern "C" fn ferment_example_identity_identity_IdentityV0_get_id (obj : * const ferment_example_identity_identity_IdentityV0) -> * mut crate :: fermented :: types :: ferment_example :: nested :: ferment_example_nested_Identifier{
                    (*obj).id
                }
                #[doc = r" # Safety"]
                #[no_mangle]
                pub unsafe extern "C" fn ferment_example_identity_identity_IdentityV0_get_public_keys (obj : * const ferment_example_identity_identity_IdentityV0) -> * mut crate :: fermented :: generics :: std_collections_Map_keys_ferment_example_identity_identity_KeyID_values_ferment_example_identity_identity_IdentityPublicKey{
                    (*obj).public_keys
                }
                #[doc = r" # Safety"]
                #[no_mangle]
                ...
                #[doc = r" # Safety"]
                #[no_mangle]
                pub unsafe extern "C" fn ferment_example_identity_identity_IdentityV0_get_revision (obj : * const ferment_example_identity_identity_IdentityV0) -> * mut crate :: fermented :: types :: ferment_example :: identity :: identity :: ferment_example_identity_identity_Revision{
                    (*obj).revision
                }
                #[doc = r" # Safety"]
                #[no_mangle]
    ...
    pub mod ferment_example_nested {
        ...
        impl ferment_interfaces::FFIConversion<crate::SomeStruct> for ferment_example_nested_SomeStruct {
            unsafe fn ffi_from_const(
        ...
        pub mod model {
            pub mod snapshot {
                ...
                #[repr(C)]
                #[derive(Clone)]
                pub struct ferment_example_nested_model_snapshot_LLMQSnapshot {
                    pub member_list : * mut crate :: fermented :: generics :: Vec_u8 ,
                    pub skip_list : * mut crate :: fermented :: generics :: Vec_i32 ,
                    pub skip_list_mode : * mut crate::fermented::types::ferment_example_nested::model::snapshot::ferment_example_nested_model_snapshot_LLMQSnapshotSkipMode ,
                    pub option_vec : * mut crate :: fermented :: generics :: Vec_u8
                }
                impl ferment_interfaces::FFIConversion<crate::model::snapshot::LLMQSnapshot>
                    for ferment_example_nested_model_snapshot_LLMQSnapshot
                {
                    ...
                    unsafe fn ffi_to_const(
                        obj: crate::model::snapshot::LLMQSnapshot,
                ...
                #[doc = r" # Safety"]
                #[no_mangle]
                pub unsafe extern "C" fn ferment_example_nested_model_snapshot_LLMQSnapshot_get_skip_list_mode (obj : * const ferment_example_nested_model_snapshot_LLMQSnapshot) -> * mut crate::fermented::types::ferment_example_nested::model::snapshot::ferment_example_nested_model_snapshot_LLMQSnapshotSkipMode{
                    (*obj).skip_list_mode
                }
                #[doc = r" # Safety"]
                #[no_mangle]
                ...
                pub unsafe extern "C" fn ferment_example_nested_model_snapshot_LLMQSnapshot_set_skip_list_mode(
                    obj: *mut ferment_example_nested_model_snapshot_LLMQSnapshot,
                    value: *mut ferment_example_nested_model_snapshot_LLMQSnapshotSkipMode,
                ) {
...
pub mod generics {
    #[repr(C)]
    #[derive(Clone)]
    pub struct Vec_ferment_example_nested_FeatureVersion {
        pub count : usize , pub values : * mut * mut crate :: fermented :: types :: ferment_example :: nested :: ferment_example_nested_FeatureVersion
    }
    ...
    #[repr(C)]
    #[derive(Clone)]
    pub struct std_collections_Map_keys_ferment_example_identity_identity_KeyID_values_ferment_example_identity_identity_IdentityPublicKey {
            pub count : usize ,
            pub keys : * mut * mut crate :: fermented :: types :: ferment_example :: identity :: identity :: ferment_example_identity_identity_KeyID ,
            pub values : * mut * mut crate :: fermented :: types :: ferment_example :: identity :: identity :: ferment_example_identity_identity_IdentityPublicKey
        }
    impl ferment_interfaces :: FFIConversion < std :: collections :: BTreeMap < ferment_example :: identity :: identity :: KeyID , ferment_example :: identity :: identity :: IdentityPublicKey > > for std_collections_Map_keys_ferment_example_identity_identity_KeyID_values_ferment_example_identity_identity_IdentityPublicKey {
            unsafe fn ffi_from_const (ffi : * const std_collections_Map_keys_ferment_example_identity_identity_KeyID_values_ferment_example_identity_identity_IdentityPublicKey) -> std :: collections :: BTreeMap < ferment_example :: identity :: identity :: KeyID , ferment_example :: identity :: identity :: IdentityPublicKey > {
                let ffi_ref = & * ffi ;
                ferment_interfaces :: fold_to_map (ffi_ref . count , ffi_ref . keys , ffi_ref . values , | o | ferment_interfaces :: FFIConversion :: ffi_from (o) , | o | ferment_interfaces :: FFIConversion :: ffi_from (o))
            }
            unsafe fn ffi_to_const (obj : std :: collections :: BTreeMap < ferment_example :: identity :: identity :: KeyID , ferment_example :: identity :: identity :: IdentityPublicKey >) -> * const std_collections_Map_keys_ferment_example_identity_identity_KeyID_values_ferment_example_identity_identity_IdentityPublicKey {
                ferment_interfaces :: boxed (Self { count : obj . len () , keys : ferment_interfaces :: to_complex_vec (obj . keys () . cloned ()) , values : ferment_interfaces :: to_complex_vec (obj . values () . cloned ()) })
            }
            unsafe fn destroy (ffi : * mut std_collections_Map_keys_ferment_example_identity_identity_KeyID_values_ferment_example_identity_identity_IdentityPublicKey) {
                ferment_interfaces :: unbox_any (ffi) ; ;
            }
        }
    ...
    #[repr(C)]
    #[derive(Clone)]
    pub struct Result_ok_ferment_example_identity_identity_Identity_err_crate_nested_ProtocolError {
        pub ok : * mut crate :: fermented :: types :: ferment_example :: identity :: identity :: ferment_example_identity_identity_Identity ,
        pub error : * mut crate :: fermented :: types :: ferment_example::nested::ferment_example_nested_ProtocolError
    }
    impl
        ferment_interfaces::FFIConversion<
            Result<ferment_example::identity::identity::Identity, ferment_example::nested::ProtocolError>,
        > for Result_ok_ferment_example_identity_identity_Identity_err_crate_nested_ProtocolError
    {
        unsafe fn ffi_from_const(
            ffi : * const Result_ok_ferment_example_identity_identity_Identity_err_crate_nested_ProtocolError,
        ) -> Result<ferment_example::identity::identity::Identity, ferment_example::nested::ProtocolError>
        {
            let ffi_ref = &*ffi;
        ...
        unsafe fn ffi_to_const (obj : Result < ferment_example :: identity :: identity :: Identity , ferment_example :: nested :: ProtocolError >) -> * const Result_ok_ferment_example_identity_identity_Identity_err_crate_nested_ProtocolError{
        ...
        unsafe fn destroy(
            ffi : * mut Result_ok_ferment_example_identity_identity_Identity_err_crate_nested_ProtocolError,
        ) {
            ferment_interfaces::unbox_any(ffi);
        }
    }
    impl Drop for Result_ok_ferment_example_identity_identity_Identity_err_crate_nested_ProtocolError {
        fn drop(&mut self) {
            unsafe {
                if !self.ok.is_null() {
    ...
    #[doc = r" # Safety"]
    #[no_mangle]
    pub unsafe extern "C" fn Result_ok_ferment_example_identity_identity_Identity_err_crate_nested_ProtocolError_ctor(
        ok : * mut crate :: fermented :: types :: ferment_example :: identity :: identity :: ferment_example_identity_identity_Identity,
        error: *mut crate::fermented::types::ferment_example::nested::ferment_example_nested_ProtocolError,
    ) -> *mut Result_ok_ferment_example_identity_identity_Identity_err_crate_nested_ProtocolError
    {
        ferment_interfaces::boxed(
            Result_ok_ferment_example_identity_identity_Identity_err_crate_nested_ProtocolError {
                ok,
                error,
            },
        )
    ...
    #[doc = r" # Safety"]
    #[no_mangle]
    pub unsafe extern "C" fn Result_ok_ferment_example_identity_identity_Identity_err_crate_nested_ProtocolError_destroy(
        ffi : * mut Result_ok_ferment_example_identity_identity_Identity_err_crate_nested_ProtocolError,
    ) {
        ferment_interfaces::unbox_any(ffi);
    }
