...
pub mod types {
    ...
    pub mod ferment_example_nested {
        use crate as ferment_example_nested;
        #[doc = "FFI-representation of the [`ferment_example_nested :: Processor`]"]
        #[no_mangle]
        pub unsafe extern "C" fn ferment_example_nested_Processor_ctor(
            chain_id: *mut dyn ferment_example_nested::CoreProvider,
        ) -> *mut ferment_example_nested::Processor {
            ferment_interfaces::boxed(ferment_example_nested::Processor {
                chain_id: Box::from_raw(chain_id),
            })
        }
        #[no_mangle]
        pub unsafe extern "C" fn ferment_example_nested_Processor_destroy(
            ffi: *mut ferment_example_nested::Processor,
        ) {
            ferment_interfaces::unbox_any(ffi);
        }
        #[doc = "FFI-representation of the [`ferment_example_nested :: DashSharedCore`]"]
        #[no_mangle]
        pub unsafe extern "C" fn ferment_example_nested_DashSharedCore_ctor(
            processor: *mut ferment_example_nested::Processor,
            cache: *mut crate::fermented::generics::std_collections_Map_keys_String_values_String,
            context: *mut std::os::raw::c_void,
        ) -> *mut ferment_example_nested::DashSharedCore {
            ferment_interfaces::boxed(ferment_example_nested::DashSharedCore {
                processor: processor,
        ...
        #[no_mangle]
        pub unsafe extern "C" fn ferment_example_nested_DashSharedCore_destroy(
            ffi: *mut ferment_example_nested::DashSharedCore,
        ) {
            ferment_interfaces::unbox_any(ffi);
        }
        ...
        #[doc = "FFI-representation of the [`ferment_example_nested :: FFICoreProvider`]"]
        #[no_mangle]
        pub unsafe extern "C" fn ferment_example_nested_FFICoreProvider_ctor(
            block_hash_by_height: ferment_example_nested::BlockHashByHeight,
        ) -> *mut ferment_example_nested::FFICoreProvider {
            ferment_interfaces::boxed(ferment_example_nested::FFICoreProvider {
                block_hash_by_height: block_hash_by_height,
            })
        }
        #[no_mangle]
        pub unsafe extern "C" fn ferment_example_nested_FFICoreProvider_destroy(
            ffi: *mut ferment_example_nested::FFICoreProvider,
        ) {
            ferment_interfaces::unbox_any(ffi);
        }
        ...
        #[doc = "FFI-representation of the [`ferment_example_nested :: LLMQParams`]"]
        #[repr(C)]
        #[derive(Clone)]
        pub struct ferment_example_nested_LLMQParams {
            pub r#type: *mut std::os::raw::c_char,
            pub known_confirmed_at_height: *mut u32,
        }
        impl ferment_interfaces::FFIConversion<ferment_example_nested::LLMQParams>
            for ferment_example_nested_LLMQParams
        {
            unsafe fn ffi_from_const(
                ffi: *const ferment_example_nested_LLMQParams,
            ) -> ferment_example_nested::LLMQParams {
                let ffi_ref = &*ffi;
                ferment_example_nested::LLMQParams {
            ...
            unsafe fn ffi_to_const(
                obj: ferment_example_nested::LLMQParams,
            ) -> *const ferment_example_nested_LLMQParams {
                ferment_interfaces::boxed(ferment_example_nested_LLMQParams {
            ...
            unsafe fn destroy(ffi: *mut ferment_example_nested_LLMQParams) {
                ferment_interfaces::unbox_any(ffi);
            }
        }
        impl Drop for ferment_example_nested_LLMQParams {
            fn drop(&mut self) {
                unsafe {
                    let ffi_ref = self;
                    <std::os::raw::c_char as ferment_interfaces::FFIConversion<String>>::destroy(
        ...
        #[no_mangle]
        pub unsafe extern "C" fn ferment_example_nested_LLMQParams_ctor(
            r#type: *mut std::os::raw::c_char,
            known_confirmed_at_height: *mut u32,
        ) -> *mut ferment_example_nested_LLMQParams {
            ferment_interfaces::boxed(ferment_example_nested_LLMQParams {
                r#type,
        ...
        #[no_mangle]
        pub unsafe extern "C" fn ferment_example_nested_LLMQParams_destroy(
            ffi: *mut ferment_example_nested_LLMQParams,
        ) {
            ferment_interfaces::unbox_any(ffi);
        }
        #[no_mangle]
        pub unsafe extern "C" fn ferment_example_nested_LLMQParams_get_type(
            obj: *const ferment_example_nested_LLMQParams,
        ) -> *mut std::os::raw::c_char {
            (*obj).r#type
        }
        #[no_mangle]
        pub unsafe extern "C" fn ferment_example_nested_LLMQParams_get_known_confirmed_at_height(
            obj: *const ferment_example_nested_LLMQParams,
        ) -> *mut u32 {
            (*obj).known_confirmed_at_height
        }
        #[no_mangle]
        pub unsafe extern "C" fn ferment_example_nested_LLMQParams_set_type(
            obj: *mut ferment_example_nested_LLMQParams,
            value: *mut std::os::raw::c_char,
        ) {
            (*obj).r#type = value;
        }
        #[no_mangle]
        pub unsafe extern "C" fn ferment_example_nested_LLMQParams_set_known_confirmed_at_height(
            obj: *mut ferment_example_nested_LLMQParams,
            value: *mut u32,
        ) {
            ...
            pub mod callback {
                ...
                pub unsafe extern "C" fn ferment_example_nested_model_callback_setup_two_callbacks(
                    ...
                    let obj = ferment_example_nested::model::callback::setup_two_callbacks(
                        |o_0, o_1| unsafe { (&*_callback1).call(o_0, o_1) },
                        |o_0| unsafe { (&*_callback2).call(o_0) },
                    );
                }
            }
            pub mod ferment_example {
