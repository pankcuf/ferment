...
pub mod types {
    pub mod ferment_example_entry_point {
        ...
        pub mod entry {
            ...
            pub mod rnt {
                use crate as ferment_example_entry_point;
                #[doc = "FFI-representation of the [`ferment_example_entry_point :: entry :: rnt :: DashSharedCoreWithRuntime :: with_pointers`]"]
                #[no_mangle]
                pub unsafe extern "C" fn ferment_example_entry_point_entry_rnt_DashSharedCoreWithRuntime_with_pointers(
                    block_hash_by_height: ferment_example_entry_point::entry::BlockHashByHeight,
                    model_by_height: ferment_example_entry_point::entry::ModelByHeight,
                    runtime: *mut tokio::runtime::Runtime,
                    context: *mut std::os::raw::c_void,
                ) -> *mut ferment_example_entry_point::entry::rnt::DashSharedCoreWithRuntime
                {
                    let obj = ferment_example_entry_point :: entry :: rnt :: DashSharedCoreWithRuntime :: with_pointers (block_hash_by_height , model_by_height , runtime , context) ;
                    ferment_interfaces::boxed(obj)
                }
                #[doc = "FFI-representation of the [`ferment_example_entry_point :: entry :: rnt :: DashSharedCoreWithRuntime :: with_lambdas`]"]
                #[no_mangle]
                pub unsafe extern "C" fn ferment_example_entry_point_entry_rnt_DashSharedCoreWithRuntime_with_lambdas(
                    block_hash_by_height : * mut crate :: fermented :: generics :: Fn_ARGS_u32_RTRN_Arr_u8_32,
                    model_by_height : * mut crate :: fermented :: generics :: Fn_ARGS_u32_RTRN_ferment_example_entry_point_entry_SomeModel,
                    runtime: *mut tokio::runtime::Runtime,
                    context: *mut std::os::raw::c_void,
                ...
                {
                    let obj = ferment_example_entry_point :: entry :: rnt :: DashSharedCoreWithRuntime :: with_lambdas (move | o_0 | unsafe { (& * block_hash_by_height) . call (o_0) } , move | o_0 | unsafe { (& * model_by_height) . call (o_0) } , runtime , context) ;
                    ferment_interfaces::boxed(obj)
                }
            }
            pub mod processor {
...
pub mod generics {
    ...
    pub struct Fn_ARGS_Arr_u8_32_RTRN_u32 {
        ...
        caller: fn(*mut crate::fermented::generics::Arr_u8_32) -> u32,
    ...
    pub struct Fn_ARGS_u32_RTRN_Option_String {
        pub context: *const std::os::raw::c_void,
        caller: fn(u32) -> *mut std::os::raw::c_char,
